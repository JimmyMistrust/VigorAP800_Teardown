...
var StationList = "<% getWlanStaInfo_5g(); %>";
...
function strFormat(str, len, type)
{
var i, left, right;
var left_str = "";
...
document.station_list.sltShowMac.options[i] = new Option(aryStationMac[i] + space +
strFormat(aryStationSSID[i], 35, 1) +
strFormat(aryStationAuthMode[i], 24, 0) +
strFormat(aryStationEncrypt[i], 9, 0));
}
...
frmSubmit.action = "/goform/wirelessStaionToAccess_5g";
...
e.innerHTML = _("parent wireless lan 5g")+" >> "+_("stalist title");
...
if (wl_5g == "0" && !window.opener) {
showElmtById(document, "warning");
document.station_list.stalistRefresh.disabled = true;
}
for (i = 0; i < MBSSID_MAX; i++) {
...
<tr>
<td width="155" id="stalistMacAddr">MAC Address</td>
<td align="center" width="255" id="stalistSSID">SSID</td>
<td width="165" id="stalistAuth">Auth</td>
<td width="75" id="stalistEncrypt">Encrypt</td>
</tr>
<tr>
<td colspan="4">
...
<tr align="center"><td colspan="4"><input type="button" id="stalistRefresh" name="stalistRefresh" value="Refresh" onclick="window.location.reload()" /></td></tr>
<tr class="nowiz" style="display:none"><td colspan="4"><hr size="1" /></td></tr>
<tr class="nowiz" style="display:none">
<td colspan="4" class="title">
<span id="stalistStr1">Add to</span>&nbsp;
<a href="/wireless/access_5g.asp" id="stalistStr2">Access Control</a> :<br /><br /></td>
</tr>
<tr class="nowiz" style="display:none">
<td colspan="4">
