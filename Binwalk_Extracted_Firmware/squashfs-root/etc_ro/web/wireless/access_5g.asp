...
var AccessPolicy = [ <% getCfgZero(1, "AccessPolicy0_3572"); %>,
<% getCfgZero(1, "AccessPolicy1_3572"); %>,
<% getCfgZero(1, "AccessPolicy2_3572"); %>];
var AccessControlList = [ "<% getAccessPolicy_5g(0); %>",
"<% getAccessPolicy_5g(1); %>",
"<% getAccessPolicy_5g(2); %>"];
...
alert("Setting full! Already set 64 MAC Address Filters!");
return false;
}
...
frmSubmit.action = "/goform/wirelessAccessPolicy_5g";
...
cfg = cfg.replace(/\s+$/, "");
var tmp = scfgNameLeading + "acl5g_" + "\\w*\\.cfg$";
...
e.innerHTML = _("parent wireless lan 5g")+" >> "+_("access title");
...
e.innerHTML = _("access limitentry_5g");
...
<input type="button" name="btnCcl1" id="btnCcl0" value="Cancel" class="btnw" onclick="onClkBtnCcl(0)"/>&nbsp;<span id="acs_limitentry0">Limit:64 entries</span>
</td>
</tr>
</table>
</td></tr>
...
<input type="button" name="btnCcl1" id="btnCcl1" value="Cancel" class="btnw" onclick="onClkBtnCcl(1)"/>&nbsp;<span id="acs_limitentry1">Limit:64 entries</span>
</td>
</tr>
</table>
</td></tr>
...
<input type="button" name="btnCcl1" id="btnCcl2" value="Cancel" class="btnw" onclick="onClkBtnCcl(2)"/>&nbsp;<span id="acs_limitentry2">Limit:64 entries</span>
</td>
</tr>
</table>
</td></tr>
...
<input type="hidden" name="backuptype" value="acl5g">
</td>
</tr>
</table>
</form>
