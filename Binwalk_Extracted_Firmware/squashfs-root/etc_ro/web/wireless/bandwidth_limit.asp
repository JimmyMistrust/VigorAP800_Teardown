...
var val = '<% getCfgGeneral(1, "BandwidthLimit"); %>';
...
e.innerHTML = _("parent wireless lan")+" >> "+_("limit title");
for (i = 0; i < 4; i++) {
...
alert("In SSID"+(i+1)+", total upload bandwidth MUST be larger than upload limit");
return false;
}
if ((enable == "1") && dlimit >= adlimit){
alert("In SSID"+(i+1)+", total download bandwidth MUST be larger than download limit");
return false;
}
}
setVle2Elmt(document.frm.commit_value, str, 0);
return true;
}
</script>
</head>
...
<form method="post" name="frm" action="/goform/wirelessLimit" onSubmit="return CheckValue()">
...
<table width="600" cellspacing="2" cellpadding="2" border="0" align="center">
<tr><td id="bSsid3" width="35%" style="text-indent: 10px">SSID</td>
<td id="bSsidStr3" width="65%" colspan="4"></td>
</tr>
<tr><td id="bSubTitle3" class="title" colspan="5">Per Station Bandwidth Limit</td>
</tr>
<tr><td id="bEnable3" style="text-indent:10px; font-weight:bold">Enable</td>
<td colspan="4"><input type="checkbox" name="enable_limit" value="0" onClick="enableChange()"></td>
</tr>
<tr><td id="bUpload3" style="text-indent: 10px">Upload Limit</td>
<td><select name="u_limit" size="1" onChange="limitChange()">
<option value="custom" id="bUUser3" selected="selected">User defined</option>
<option value="64k">64K</option>
<option value="128k">128K</option>
<option value="256k">256K</option>
<option value="512k">512K</option>
...
<td><input type="text" name="u_limit_user" id="u_limit_user3" value="K" size="6" maxlength="8" style="display:inline"></td>
<td>bps</td>
<td id="bNoteUUnit3">(Default unit : K)</td>
</tr>
<tr><td id="bDownload3" style="text-indent: 10px">Download Limit</td>
<td><select name="d_limit" size="1" onChange="limitChange()">
<option value="custom" id="bDUser3" selected="selected">User defined</option>
<option value="64k">64K</option>
<option value="128k">128K</option>
<option value="256k">256K</option>
<option value="512k">512K</option>
...
<td><input type="text" name="d_limit_user" id="d_limit_user3" value="K" size="6" maxlength="8" style="display:inline"></td>
<td>bps</td>
<td id="bNoteDUnit3">(Default unit : K)</td>
</tr>
<tr><td id="bAuto3" style="text-indent: 10px">Auto Adjustment</td>
<td colspan="2"><input type="checkbox" name="auto" value="0" onClick="adjustChange()"/></td>
</tr>
<tr id="adj_u3"><td id="adj_bUpload3" style="text-indent: 10px">Total Upload Bandwidth</td>
<td><select name="adj_u_limit" id="adj_u_limit3" size="1" onChange="limitChange()">
<option value="custom" id="adj_bUUser3" selected="selected">User defined</option>
<option value="64k">64K</option>
<option value="128k">128K</option>
<option value="256k">256K</option>
<option value="512k">512K</option>
...
<td><input type="text" name="adj_u_limit_user" id="adj_u_limit_user3" value="K" size="6" maxlength="8" style="display:inline"></td>
<td>bps</td>
<td id="adj_bNoteUUnit3">(Default unit : K)</td>
</tr>
<tr id="adj_d3"><td id="adj_bDownload3" style="text-indent: 10px">Total Download Bandwidth</td>
<td><select name="adj_d_limit" id="adj_d_limit3" size="1" onChange="limitChange()">
<option value="custom" id="adj_bDUser3" selected="selected">User defined</option>
<option value="64k">64K</option>
<option value="128k">128K</option>
<option value="256k">256K</option>
<option value="512k">512K</option>
...
<td><input type="text" name="adj_d_limit_user" id="adj_d_limit_user3" value="K" size="6" maxlength="8" style="display:inline"></td>
<td>bps</td>
<td id="adj_bNoteDUnit3">(Default unit : K)</td>
</tr>
</table>
