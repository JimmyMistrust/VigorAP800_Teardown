...
if (typeof(opener.g_auth) != "undefined" && typeof(opener.g_encry)!= "undefined") {
if (opener.g_auth.indexOf("WPA") >=0) {
if (opener.g_auth.indexOf("WPA2") >=0)
document.sta_site_survey_connection.security_infra_mode.options.selectedIndex = 3;
else
document.sta_site_survey_connection.security_infra_mode.options.selectedIndex = 2;
if (opener.g_encry.indexOf("TKIP") >=0)
document.sta_site_survey_connection.cipher[0].checked = true;
else //if (opener.g_auth.indexOf("OPEN") >=0)
document.sta_site_survey_connection.cipher[1].checked = true;
}
else //if (opener.g_auth.indexOf("OPEN") >=0)
document.sta_site_survey_connection.security_infra_mode.options.selectedIndex = 0;
} else {
document.sta_site_survey_connection.security_infra_mode.options.selectedIndex = 0;
document.sta_site_survey_connection.cipher[0].checked = true;
}
...
<td>
<input type=radio name="cipher" id="cipher" value="0">TKIP &nbsp;
...
<tr align="center">
<td>
<input type=button style="{width:120px;}" value="OK" id="connectApply" onClick="submit_apply()"> &nbsp; &nbsp;
