...
e.innerHTML = _("parent wireless lan")+" >> "+_("11n title");
...
<div>
<h2 id="11nConfig" class="title">11n Configuration</h2>
<table width="100%" cellpadding="2" cellspacing="1" class="config">
<tr>
<td class="head" rowspan="2" id="11nAMPDU" valign="top">MPDU Aggregation</td>
...
<tr align="center"><td>
<input type="button" class="btnw" value="OK" id="11nApply" onClick="submit_apply()">
</td></tr>
</table>
</div>
</form>
