...
e.innerHTML = _("wiz title") + " >> " + _("wiz 5g security");
...
UpdateId("wlSecSSID0Value", w.wSsid1_5g);
UpdateId("wlSecSSID1Value", w.wSsid2_5g);
UpdateId("wlSecSSID2Value", w.wSsid3_5g);

var arySsid = [w.wSsid1_5g, w.wSsid2_5g, w.wSsid3_5g];
for(var i=0; i<3; i++) {
if (arySsid[i] == "") {
...
w.wWLSecMode_5g[i] = getVleFromElmt(f[id_x], 0);
...
w.wPassphrase_5g[i] = eval("f.passphrase_"+i).value;
w.wKeyRenewalInterval_5g[i] = eval("f.keyRenewalInterval_"+i).value;
w.wPMKCachePeriod_5g[i] = eval("f.PMKCachePeriod_"+i).value;

if(eval("f.PreAuthentication_"+i)[0].checked)
w.wPreAuthentication_5g[i] = 0;
else if(eval("f.PreAuthentication_"+i)[1].checked)
w.wPreAuthentication_5g[i] = 1;

for (var j = 0; j < 4; j++) {
if (eval("f.wep_default_key_"+i)[j].checked)
w.wWep_default_key_5g[i] = j+1;
}
w.wWep_key_1_5g[i] = eval("f.wep_key_1_"+i).value;
w.wWep_key_2_5g[i] = eval("f.wep_key_2_"+i).value;
w.wWep_key_3_5g[i] = eval("f.wep_key_3_"+i).value;
w.wWep_key_4_5g[i] = eval("f.wep_key_4_"+i).value;
w.wWEP1Select_5g[i] = (eval("f.WEP1Select_"+i).selectedIndex == 0 ? 1 : 0);
w.wWEP2Select_5g[i] = (eval("f.WEP2Select_"+i).selectedIndex == 0 ? 1 : 0);
w.wWEP3Select_5g[i] = (eval("f.WEP3Select_"+i).selectedIndex == 0 ? 1 : 0);
w.wWEP4Select_5g[i] = (eval("f.WEP4Select_"+i).selectedIndex == 0 ? 1 : 0);

if(eval("f.ieee8021x_wep_"+i)[0].checked)
w.wIeee8021x_wep_5g[i] = 0;
else if(eval("f.ieee8021x_wep_"+i)[1].checked)
w.wIeee8021x_wep_5g[i] = 1;

w.wRadiusServerIP_5g[i] = eval("f.RadiusServerIP_"+i).value;
w.wRadiusServerPort_5g[i] = eval("f.RadiusServerPort_"+i).value;
w.wRadiusServerSecret_5g[i] = eval("f.RadiusServerSecret_"+i).value;
w.wRadiusServerSessionTimeout_5g[i] = eval("f.RadiusServerSessionTimeout_"+i).value;
}
