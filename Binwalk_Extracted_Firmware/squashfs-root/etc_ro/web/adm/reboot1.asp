...
document.getElementById("vlan2_ip").style.visibility = "";
document.getElementById("vlan2_ip").style.display = "";
document.getElementById("vlan_a").style.visibility = "";
document.getElementById("vlan_a").style.display = "";
}
}
</script>
</head>
...
<b><span id="vlan_a" style="display:none">LAN-A&nbsp;</span><a href="javascript:top.location='http://<% getLanIp(); %>:<% getCfgGeneral(1, "HTTP_ServerPort"); %>'">http:// <% getLanIp(); %>:<% getCfgGeneral(1, "HTTP_ServerPort"); %></a></b><br>
<span id="vlan2_ip" style="display:none">
<b>LAN-B&nbsp;<a href="javascript:top.location='http://<% getLan2Ip(); %>:<% getCfgGeneral(1, "HTTP_ServerPort"); %>'">http:// <% getLan2Ip(); %>:<% getCfgGeneral(1, "HTTP_ServerPort"); %></a></b><br>
</span>
